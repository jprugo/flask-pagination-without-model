...
def configure_routes(app, db):
    ...
    def handle_personas():
        ...
        pageSize = args.get('pageSize', default=2)
        ...
        return {
            'Info': {
                "pagination_next": f'{baseUrl}?creationDate=2022-02-28&page={pagination.page+1}' if pagination.has_next else None,
                "pagination_prev": f'{baseUrl}?creationDate=2022-02-28&page={pagination.page-1}' if pagination.has_prev else None,
